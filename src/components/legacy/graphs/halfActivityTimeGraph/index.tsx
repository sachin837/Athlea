...
const HalfActivityTimeGraph = ({activitiesData, filterType}) => {
  ...
  // Adjusted to ensure proper scaling and display
  const processedData = activitiesData.map(activity => {
    const date = parseISO(activity.date);
    const hour = getHours(date);

    // Only modify the activities data for 'Day' filter type
...
export default HalfActivityTimeGraph;
